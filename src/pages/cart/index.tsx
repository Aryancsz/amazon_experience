          ...
          <div>
            ...
            {items.length > 0 ? (
              ...
              <p className='text-gray-700 mt-1 text-sm w-2/3'>
                ...
                <span className='text-indigo-500'>Amazon.in homepage</span>,
                learn about{" "}
                <span className='text-indigo-500'>today&apos;s deals,</span> or
                visit your <span className='text-indigo-500'>Wish List.</span>
              </p>
            )}
        ...
        <div className='w-[20vw] bg-white p-7 mx-3 my-10 h-[30vh]'>
          <div className='text-lg mb-1 flex'>
            ...
            <p className='font-bold ml-2'>
              {dollarToINDIAN(calculateTotalCost(items)).toLocaleString(
                "en-IN"
              )}
            </p>
          </div>
